            ...
            <div className="absolute h-1/2 w-1/3 left-1/3 top-1/4 shadow-xl">
                <div className="max-w-sm rounded overflow-hidden shadow-lg">
                    <div className="px-6 py-4 bg-gray-300 opacity-60">
                        <p className="animate__animated animate__fadeInUp flex flex-wrap text-black text-bold text-lg font-serif font-medium"> <span className="text-5xl font-bold text-blue-900">GeekzMeet</span> is a dating site where you get
